...
param_call_2 <- function(endpoint = 1, limit = NULL,field=NULL,value=NULL,operator=NULL){
...
```{r example, echo=TRUE}
endpoint = 1
value = c("gaza","Cheat","Sheet")
field = c("title","title","title")
operator = "AND"
res = param_call_2(endpoint = endpoint,limit = 100,field = field,value = value)
```
